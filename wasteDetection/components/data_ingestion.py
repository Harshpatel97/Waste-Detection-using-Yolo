...
class DataIngestion:
    ...
    def download_data(self)-> str:
        ...
        try:
            ...
            logging.info(f"Downloading the data from {dataset_url}into file {zip_file_path}") 
    ...
    def extract_zip_file(self, zip_file_path: str):
        """
        Args:
            zip_file (str): Extracts the zip file path into data directory.             
        """
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        logging.info("Entering intitate_data_ingestion method of Data ingestion Class")
        try:
            ...
            logging.info("Exited data_ingestion_method of Data Ingestion class")
